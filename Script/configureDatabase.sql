...
CREATE TABLE "TAG" (
    ...
    "USER"          INT FOREIGN KEY REFERENCES [USER]("USER-ID") ON DELETE CASCADE,
    "TMS-CREATED"   DATETIME DEFAULT CURRENT_TIMESTAMP
) 
GO
...
CREATE TABLE "TAG-VALIDATION" (
    ...
    "TAG"           INT FOREIGN KEY REFERENCES [TAG]("TAG-ID") ON DELETE CASCADE,
    "VALIDATED-BY"  INT FOREIGN KEY REFERENCES [USER]("USER-ID") ON DELETE CASCADE,
...
CREATE TABLE "CONTACT" (
    "USER"          INT FOREIGN KEY REFERENCES [USER]("USER-ID") ON DELETE CASCADE,
    "CONTACT"       INT FOREIGN KEY REFERENCES [USER]("USER-ID") ON DELETE CASCADE,
    "TMS-CREATED"   DATETIME DEFAULT CURRENT_TIMESTAMP
) 
GO
...
SELECT [USER].[USER-ID],
       ...
       [USER].[COURSE],
       [USER].[SPECIALIZATION],
       CONCAT([USER].[EMAIL-PREFIX], '@', [DHBW].[EMAIL-DOMAIN]) AS EMAIL,
       [USER].[CITY],
       [USER].[BIO],
       [USER].[IS-VERIFIED],
       [USER].[TMS-CREATED]
